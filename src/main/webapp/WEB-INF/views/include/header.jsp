                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <c:if test="${!empty login }">
                     <a href="${pageContext.request.contextPath}/user/logout" id="btnlogout" class="btn btn-default btn-flat">Logout</a>
                    </c:if>
                    <c:if test="${empty login }">
                     <a href="${pageContext.request.contextPath}/user/login" id="btnlogin" class="btn btn-default btn-flat">Login</a>
                    </c:if>
                    </div>
                  </li>
                </ul>
